"""
Runtime Workman Email Template
Template for sending Runtime Workman mobile app login credentials to employees
"""
...
def generate_runtime_workman_html(context: Dict) -> str:
    """
    Generate HTML email for Runtime Workman login credentials.
    ...
    <head>
        ...
        <title>Runtime Workman Login Details</title>
    </head>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p style="margin: 0; font-size: 18px; font-weight: 300; color: #d0d0d0; line-height: 1.5;">
                                                Please note your Runtime Workman login details:
                                            </p>
                                        </td>
                                    </tr>
                                </table>
...
def generate_runtime_workman_text(context: Dict) -> str:
    """
    Generate plain text email for Runtime Workman login credentials.
